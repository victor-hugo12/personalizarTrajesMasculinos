...
import { BUTTON_OPTIONS_COAT, LAPEL_OPTIONS, POCKET_OPTIONS, THIRD_POCKET_OPTIONS } from '@/constants/selections'
...
export const CoatCustomOptions = () => {
